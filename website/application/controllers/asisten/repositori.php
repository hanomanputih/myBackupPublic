...
class Repositori extends CI_Controller{
    ...
    {
        redirect(base_url()."asisten/repositori/materi","refresh");
        exit;   
    }
    ...
    public function materi($menu="",$id="")
    {
        ...
        $dataToView["content"] = $this->load->view("content/asisten/repositori/materi/list_materi",$dataToSend,TRUE);
        if($menu == "tambah")
        {
            if($this->session->userdata("ta_status") == "active")
            {
                ...
                $dataToView["content"] = $this->load->view("content/asisten/repositori/materi/add_materi",$dataToSend,TRUE);
            }
            else
            {
                redirect(base_url()."asisten/repositori");
                exit;
            }
        }
        else if($menu == "hapus")
    ...
    public function edit($id="")
    {
        if(!empty($id))
        {
            if($this->session->userdata("ta_status") == "active")
            {
                ...
                $dataToView["content"] = $this->load->view("content/asisten/repositori/materi/edit_materi",$dataToSend,TRUE);
                $this->load->view("template/template_admin",$dataToView);
            }
            else
            {
        ...
        {
            redirect(base_url()."asisten/repositori","refresh");
            exit;
        }
    }
...
//    imamsrifkan : fungsi untuk proses menambahkan data repositori
    public function upload()
    {
        if($this->session->userdata("ta_status") == "active")
        {
            ...
            {
                redirect(base_url()."asisten/repositori/".$this->input->post("kategori-repo"),"refresh");
                exit;
            }
    ...
    //        imamsrifkan : konfigurasi file upload
            ...
            $dataToView["content"] = $this->load->view("content/asisten/repositori/".$dataToSave["repo_kategori"]."/add_materi",$dataToSend,TRUE);
            $this->load->view("template/template_admin",$dataToView);
        }
        else
        {
    ...
    //        imamsrifkan : konfigurasi file upload
            ...
            $dataToView["content"] = $this->load->view("content/asisten/repositori/edit_materi",$dataToSend,TRUE);
            $this->load->view("template/template_admin",$dataToView);
        }
        else
        {
