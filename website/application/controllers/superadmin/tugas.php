...
//        $dataToList["modul"] = $this->modul->getAllModul();
        $dataToSend["tugas"] = $this->tugas->getTugasByAttr(array("website_kelas_tugas.ta_id"=>  $this->session->userdata("ta_id")));
...
//        $dataToSend["sidebar"] = $this->load->view("content/sadmin/tugas/right_side",$dataToList,TRUE);
        $dataToView["content"] = $this->load->view("content/sadmin/tugas/list_tugas",$dataToSend,TRUE);
...
//    imamsrifkan : fungsi mengambil data tugas berdasarkan kelas
    public function kelas($kelas="")
    {
        ...
        $dataToSend["sidebar"] = $this->load->view("content/sadmin/tugas/right_side","",TRUE);
        $dataToSend["aktif"] = $this->kelas->getActiveKelasTugas(array("ta_id"=>  $this->session->userdata("ta_id")));
        if(!empty($kelas))
        {
            $dataToSend["tugas"] = $this->tugas->getTugasByKelas($kelas,array("website_kelas_tugas.ta_id"=>  $this->session->userdata("ta_id")));
            $dataToSend["kelas_tugas"] = $this->kelas->getKelasTugasByAttr(array("ta_id"=>  $this->session->userdata("ta_id")));
            $dataToView["content"] = $this->load->view("content/sadmin/tugas/list_tugas",$dataToSend,TRUE);
            $this->load->view("template/template_sadmin",$dataToView);
        }
