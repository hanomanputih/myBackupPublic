...
//    imamsrifkan : fungsi untuk melihat berita
    ...
    {           
        ...
        $dataToView["content"] = $this->load->view("content/sadmin/berita/list_berita",$dataToSend,TRUE);
...
//                imamsrifkan : waktu
        ...
        {
            redirect(base_url()."superadmin/berita","refresh");
            exit;
        }
        $dataToView["content"] = $this->load->view("content/sadmin/berita/add_berita",$dataToSend,TRUE);
        $this->load->view("template/template_sadmin",$dataToView);
        }
        else
        {
            redirect(base_url()."superadmin/berita");
            exit;
        }
    }
...
//    imamsrifkan : fungsi untuk menampilkan form edit berita
    public function edit($id="",$action="")
    {
        ...
        $dataToView["content"] = $this->load->view("content/sadmin/berita/edit_berita",$dataToSend,TRUE);
        $this->load->view("template/template_sadmin",$dataToView);
        }
        else
        {
    ...
    public function detail($title="")
    {
        ...
        $dataToView["content"] = $this->load->view("content/sadmin/berita/detail_berita",$dataToSend,TRUE);
        $this->load->view("template/template_sadmin",$dataToView);
    }    
