...
class Login extends CI_Controller{
    ...
    public function index()
    {
        ...
        {
            redirect(base_url()."superadmin/menu","refresh");
            exit;
        }
        else
        {
            $dataToSend["title"] = "Login Super Admin";
            $dataToView['content'] = $this->load->view("content/sadmin/login",$dataToSend,TRUE);
...
//                    setting waktu
                   ...
                   $update = $this->user->updateUser($datatoupdate);
                    ...
                    $ceklogin["berhasil"] = true;
                    echo json_encode($ceklogin);
                }
                else
                {
                    $ceklogin["berhasil"] = false;
                    echo json_encode($ceklogin);
                }
                exit;
            }
