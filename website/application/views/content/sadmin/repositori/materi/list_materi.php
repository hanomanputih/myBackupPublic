...
<script type="text/javascript">
        $(document).ready(function(){
            $("#tambah").click(function(){
                window.location.href = "<?php echo base_url()?>superadmin/repositori/materi/tambah";
            })
        })
   function edit(id){
       window.location.href = "<?php echo base_url()?>superadmin/repositori/edit/"+id;
   }
    function hapus(id){
        var conf = window.confirm("Apakah Anda yakin ingin menghapus berita ini?");
        if(conf){
            window.location.href = "<?php echo base_url()?>superadmin/repositori/materi/hapus/"+id;
        }
    }
</script>
