                        ...
                        if($pesan)
                        {
                          ...
                          foreach($pesan as $result)
                          {
                              ...
                              <tr <?php if($result['saran_status'] == 0){ echo 'class="bg-gray"';}?>>
                                  ...
                                  <td><?php echo word_limiter($result["saran_pesan"],6)?> [ <a href="<?php echo base_url()?>superadmin/pesan/detail/<?php echo $result["saran_id"]?>">detail</a> ]</td>
                                  <td align="center">
...
<script type="text/javascript">
    function hapus(id){
        ...
        if(conf){
            $.post(
            "<?php echo base_url()?>superadmin/pesan/hapus",
            {"id":id},
            function(data){
                if(data.status){
