...
<script type="text/javascript">
    $(document).ready(function(){
       ...
       $("#tambah").click(function(){
          ...
          $.post(
                "<?php echo base_url()?>superadmin/kcb/proses_tambah_responsi",
                {"tanggal_responsi":$("#tanggal-responsi").val(),"bulan_responsi":$("#bulan-responsi").val(),"tahun_responsi":$("#tahun-responsi").val(),"jam_responsi":$("#jam-responsi").val(),"ruang_responsi":$("#ruang-responsi").val()},
                function(data){
                    if(data == 1){
