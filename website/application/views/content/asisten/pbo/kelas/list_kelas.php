...
<script type="text/javascript">
    $(document).ready(function(){
       $("#tambah").click(function(){
          window.location.href = "<?php echo base_url()?>superadmin/pbo/kelas/tambah"; 
       });
       
    });

function edit(id){
    window.location.href = "<?php echo base_url()?>superadmin/pbo/kelas/edit/"+id;
}
function hapus(id){
    var konf = window.confirm("Apakah Anda yakin menghapus kelas ini?");
    if(konf){
        window.location.href = "<?php echo base_url()?>superadmin/pbo/kelas/hapus/"+id;
    }
}
