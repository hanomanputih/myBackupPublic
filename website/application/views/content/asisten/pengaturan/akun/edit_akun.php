<section id="main" class="column">
    ...
    <article class="module width_3_quarter">
        ...
        <table class="horison-padding vertical-padding">
            ...
            <tr>
                <td class="bg-gray">Username</td><td><input type="text" name="username" class="readonly" readonly id="username" value="<?php echo $akun["user_username"]?>"></td>
            </tr>
            <tr>
...
<script type="text/javascript">
    $(document).ready(function(){
       ...
       $("#simpan").click(function(){
           $.post("<?php echo base_url()?>asisten/menu/akun/validasi",
            {
                "id":$("#id").val(),
            ...
            function(data){
                if(data.message == true){
                    displayMessage("alert_success","Password Berhasil diubah");
                    $("#password").val("");
                    ...
                    displayMessage("alert_error","Password gagal diubah");
                }
            },"JSON"
       );
           $("#password-new").val("");
