<section id="secondary_bar">
        <div class="user">
                <p><?php echo $this->session->userdata("user_id");?></p>
                 <a class="logout_user" href="<?php echo base_url()?>asisten/login/logout" title="Logout">Logout</a> 
        </div>
        <div class="breadcrumbs_container">
            ...
            if($url_2)
            {
                $link = 'href="'.base_url().'asisten/'.$url_1.'"';
            ...
            ?>
                <article class="breadcrumbs">
                    <a href="<?php echo base_url()?>asisten/home">Dashboard</a>
