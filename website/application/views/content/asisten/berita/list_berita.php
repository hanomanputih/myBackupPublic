                            ...
                            if($berita)
                            {
                                ...
                                foreach($berita as $result)
                                {
                                    ...
                                    <tr>
                                        ...
                                        <td width="300px"><a href="<?php echo base_url()?>asisten/berita/detail/<?php echo $result["berita_title"]?>"><?php echo $result["berita_judul"]?></a></td>
...
<script type="text/javascript">
    function edit(id){
        window.location.href = "<?php echo base_url()?>asisten/berita/edit/"+id;
    }
    function hapus(id){
        var conf = window.confirm("Apakah Anda yakin ingin menghapus berita ini?");
        if(conf){
            window.location.href = "<?php echo base_url()?>asisten/berita/hapus/"+id;
        }
    }
</script>
