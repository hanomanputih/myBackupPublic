...
<script type="text/javascript">
    $(document).ready(function(){
       $("#non-aktif-modul").click(function(){
          window.location.href = "<?php echo base_url()?>asisten/aktifasi/modul/nonaktif";  
       });
    });
    function aktif(id){
        window.location.href = "<?php echo base_url()?>asisten/aktifasi/modul/aktif/"+id;
    }
    function nonaktif(id){
        window.location.href = "<?php echo base_url()?>asisten/aktifasi/modul/nonaktif/"+id;
    }
</script>