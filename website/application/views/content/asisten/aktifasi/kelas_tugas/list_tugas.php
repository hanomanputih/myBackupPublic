...
<script type="text/javascript">
    $(document).ready(function(){
       $("#non-aktif-tugas").click(function(){
          window.location.href = "<?php echo base_url()?>asisten/aktifasi/tugas/nonaktif"; 
       });
       
    });

function aktif(id){
    window.location.href = "<?php echo base_url()?>asisten/aktifasi/tugas/aktif/"+id;
}
function nonaktif(id){
    window.location.href = "<?php echo base_url()?>asisten/aktifasi/tugas/nonaktif/"+id;
}
