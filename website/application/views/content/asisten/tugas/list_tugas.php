                        ...
                        <div class="list-kelas">
                            <span class="data-kelas">
                                ...
                                foreach($kelas_tugas as $result)
                                {
                                    ...
                                    ?>
                                    <a <?php echo $class?> href="<?php echo base_url()?>asisten/tugas/kelas/<?php echo $result["kelas_nama"]?>"><?php echo $result["kelas_nama"]?></a>&nbsp;&nbsp;|
                                    <?php
                                }
                                ?>
                            </span>
...
<!--                                </form>-->
    ...
    <script type="text/javascript">
        function hapus(id){
            ...
            if(conf){
                $.post(
                    "<?php echo base_url()?>asisten/tugas/hapus",
                    {"id":id},
                    function(data){
                        if(data == 1){
