...
<body>
	...
	<!-- start of secondary bar -->
        <?php
        $this->load->view("content/asisten/little_navigation");
        ?>
	...
	<!-- start of sidebar -->
        ...
        {
            $this->load->view("content/asisten/navigation_active");
        }
        else if($this->session->userdata("ta_status") == "inactive")
        {
            $this->load->view("content/asisten/navigation_inactive");
        }
        else
        {
            $this->load->view("content/asisten/tahun_akademik");
        }
