...
<html>
	...
	<div id="slider">
		<ul>				
			...
			<li>
			<h2>Catatan</h2>  
			<form id="myForm" action="notice">
			<fieldset>
				<input type="hidden" name="page" id="page" value="1"/>
				<input type="hidden" name="id" id="id"/>
				<input type="hidden" name="act" id="act"/>
				<dl>
					<dt><label for="notice">Notice:</label></dt>
					<dd><textarea name="notice" id="notice" cols="37"></textarea></dd>
				</dl>
				<dl>
					<dt></dt>
					<dd>
	...
	<script  type="text/javascript">
		 ...
		 formval.addValidation('notice','req','Notice tidak boleh kosong!');
