...
<html>
	...
	<div id="slider">
		<ul>				
			...
			<li>
			<h2>Kedatangan</h2>  
			<form id="myForm" action="kedatangan">
			<fieldset>
				<input type="hidden" name="page" id="page" value="1"/>
				<input type="hidden" name="id" id="id"/>
				<input type="hidden" name="act" id="act"/>
				<dl>
					<dt><label for="nama_kedatangan">Nama kedatangan:</label></dt>
					<dd><input name="nama_kedatangan" id="nama_kedatangan" type="text" size="40"/></dd>
				</dl>
				<dl>
					<dt></dt>
					<dd>
	...
	<script  type="text/javascript">
		 ...
		 formval.addValidation('nama_kedatangan','req','Nama kedatangan tidak boleh kosong!');
