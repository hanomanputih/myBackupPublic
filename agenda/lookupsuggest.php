...
foreach ($fieldsArr as $f)
{
	...
	if ($fEditFormat != EDIT_FORMAT_LOOKUP_WIZARD || $f != $field)
	{
		continue;
	}
	...
	if ($LookupType == LT_LOOKUPTABLE)
	{
		...
		if (GetFieldData($strTableName, $f, 'UseCategory', false) && (postvalue("category") != '' || postvalue('mode') != MODE_SEARCH))
		{
