...
$categoryvalue="";
if($field=="id_bos")
	$categoryfield="id_unit";
if($field=="Jabatan")
	$categoryfield="id_bos";
if($categoryfield)
...
<br><br><input class=button type=submit value="<?php echo "Simpan"?>" name=submit1>
<input class=button type=button onClick='window.close();return false;' value="<?php echo "Tutup jendela"?>">
</div>
</form>
