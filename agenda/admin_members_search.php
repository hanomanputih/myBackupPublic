...
//--------------------------------------------------------------------------------------	
	...
	// search fields data
	$srchFields = $searchObject->getSearchCtrlParams("id_user");
	...
	{
		$firstFieldParams['fName'] = "id_user";
	...
	if(isEnableSection508())
		$xt->assign_section("id_user_label","<label for=\"".GetInputElementId("id_user", $id)."\">","</label>");
	else 
		$xt->assign("id_user_label", true);
	
	$xt->assign("id_user_fieldblock", true);		
	$xt->assignbyref("id_user_editcontrol", $ctrlBlockArr['searchcontrol']);					
	$xt->assign("id_user_notbox", $ctrlBlockArr['notbox']);		
	// create second control, if need it		
	$xt->assignbyref("id_user_editcontrol1", $ctrlBlockArr['searchcontrol1']);		
	// create search type select
	$xt->assign("searchtype_id_user", $ctrlBlockArr['searchtype']);	
	
	$suggestJS = $searchControlBuilder->createSearchSuggestJS('id_user', $id);
	$pageObject->AddJsCode($suggestJS);
	
	$ctrlsMap = $ctrlBlockArr['searchcontrol1'] ? "[0,1]" : "[0]";
	$regBlocksJS .= "searchController".$searchControllerId.".addRegCtrlsBlock('id_user', ".$pageObject->id.", ".$ctrlsMap.");";
	// search fields data
	...
	// search fields data
	$srchFields = $searchObject->getSearchCtrlParams("Passw");
	$firstFieldParams = array();
	if (count($srchFields))
	{
		$firstFieldParams = $srchFields[0];
	...
	$xt->assignbyref("Passw_editcontrol", $ctrlBlockArr['searchcontrol']);					
	$xt->assign("Passw_notbox", $ctrlBlockArr['notbox']);		
	// create second control, if need it		
	$xt->assignbyref("Passw_editcontrol1", $ctrlBlockArr['searchcontrol1']);		
	// create search type select
	$xt->assign("searchtype_Passw", $ctrlBlockArr['searchtype']);	
	
	$suggestJS = $searchControlBuilder->createSearchSuggestJS('Passw', $id);
	$pageObject->AddJsCode($suggestJS);
	
	$ctrlsMap = $ctrlBlockArr['searchcontrol1'] ? "[0,1]" : "[0]";
	$regBlocksJS .= "searchController".$searchControllerId.".addRegCtrlsBlock('Passw', ".$pageObject->id.", ".$ctrlsMap.");";
	// search fields data
