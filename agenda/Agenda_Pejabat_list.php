...
{
	if(IsAdmin())
		echo "<p>"."Anda tidak punya ijin untuk mengakses tabel ini"."<br><a href=\"admin_rights_list.php\">"."Proceed to Admin Area"."</a> "."to set up user permissions"."</p>";
	else
...
{	
	...
	//determine which field should be used to select values
			$params["lookupSelectField"] = "id_unit";
							}
