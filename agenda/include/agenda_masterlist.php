...
//	Tgl_mulai - Long Date
			$value="";
				$value = ProcessLargeText(GetData($data,"Tgl_mulai", "Long Date"),"field=Tgl%5Fmulai".$keylink);
			$xt->assign("Tgl_mulai_mastervalue",$value);

//	Tgl_akhir - Long Date
			$value="";
				$value = ProcessLargeText(GetData($data,"Tgl_akhir", "Long Date"),"field=Tgl%5Fakhir".$keylink);
			$xt->assign("Tgl_akhir_mastervalue",$value);

//	Jam_mulai - Time
			$value="";
				$value = ProcessLargeText(GetData($data,"Jam_mulai", "Time"),"field=Jam%5Fmulai".$keylink);
			$xt->assign("Jam_mulai_mastervalue",$value);

//	Jam_akhir - Time
			$value="";
				$value = ProcessLargeText(GetData($data,"Jam_akhir", "Time"),"field=Jam%5Fakhir".$keylink);
			$xt->assign("Jam_akhir_mastervalue",$value);

//	Tempat - 
			$value="";
				$value = ProcessLargeText(GetData($data,"Tempat", ""),"field=Tempat".$keylink);
			$xt->assign("Tempat_mastervalue",$value);
	$strTableName=$oldTableName;
	$xt->display("agenda_masterlist.htm");
}
