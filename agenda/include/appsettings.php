...
$cLoginTable				= "agenda_petugas";
$cUserNameField			= "Username";
$cPasswordField			= "Passw";
...
$tableCaptions["Indonesian"]["agenda"] = "Agenda";
$tableCaptions["Indonesian"]["agenda_bos"] = "Pelaksana Tugas";
$tableCaptions["Indonesian"]["agenda_hadir"] = "Hadir";
$tableCaptions["Indonesian"]["agenda_hasil"] = "Laporan";
$tableCaptions["Indonesian"]["masuk"] = "Surat Masuk";
$tableCaptions["Indonesian"]["agenda_petugas"] = "Petugas Agenda";
$tableCaptions["Indonesian"]["admin_rights"] = "Permissions";
$tableCaptions["Indonesian"]["admin_members"] = "Assign users to groups";
$tableCaptions["Indonesian"]["admin_users"] = "Add/Edit users";
$tableCaptions["Indonesian"]["Agenda_Pejabat"] = "Agenda Pejabat";

$mlang_defaultlang="Indonesian";
...
$menuTablesArr[] = array("shortTName"=>"agenda_bos","dataSourceTName"=>"agenda_bos","nType"=>0);
$menuTablesArr[] = array("shortTName"=>"agenda_hadir","dataSourceTName"=>"agenda_hadir","nType"=>0);
$menuTablesArr[] = array("shortTName"=>"agenda_hasil","dataSourceTName"=>"agenda_hasil","nType"=>0);
$menuTablesArr[] = array("shortTName"=>"masuk","dataSourceTName"=>"masuk","nType"=>0);
$menuTablesArr[] = array("shortTName"=>"Agenda_Pejabat","dataSourceTName"=>"Agenda Pejabat","nType"=>1);
