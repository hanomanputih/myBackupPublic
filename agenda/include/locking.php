...
//	add a record - try to lock
		...
		$this->TableObj->userid=$_SESSION["UserID"];
...
//	check if locking was removed by admin or not
	...
	function GetLockInfo($strtable,$keys,$links, $pageid)
	{
		...
		if($data = db_fetch_array($rstmp))
		{
			...
			{
				$str.="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
				$str.="<a class=admin_links href='#' onclick=\"UnlockAdmin('".$page."','".htmlspecialchars(jsreplace($strtable))."','".htmlspecialchars(jsreplace($skeys))."','".$data["sessionid"]."','no',".$pageid.");return false;\">".""."</a>";
				$str.="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a class=admin_links href='#' onclick=\"UnlockAdmin('".$page."','".htmlspecialchars(jsreplace($strtable))."','".htmlspecialchars(jsreplace($skeys))."','".$data["sessionid"]."','yes',".$pageid.");return false;\">".""."</a>";
			}
			return $str;
		}
		else
