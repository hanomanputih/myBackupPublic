...
class tDAL
{
	...
	function FillTablesList()
	{
	  ...
	  $this->lstTables[]=array("name"=>"agenda_bos","varname"=>"agenda_bos");
	  $this->lstTables[]=array("name"=>"agenda_hadir","varname"=>"agenda_hadir");
	  $this->lstTables[]=array("name"=>"agenda_hasil","varname"=>"agenda_hasil");
	  $this->lstTables[]=array("name"=>"masuk","varname"=>"masuk");
	  $this->lstTables[]=array("name"=>"agenda_petugas","varname"=>"agenda_petugas");
	  $this->lstTables[]=array("name"=>"agenda_ugrights","varname"=>"agenda_ugrights");
	  $this->lstTables[]=array("name"=>"unit","varname"=>"unit");
	  $this->lstTables[]=array("name"=>"agenda_uggroups","varname"=>"agenda_uggroups");
	  $this->lstTables[]=array("name"=>"agenda_ugmembers","varname"=>"agenda_ugmembers");
	}
