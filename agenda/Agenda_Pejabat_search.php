...
include("include/Agenda_Pejabat_variables.php");
...
$mode=SEARCH_SIMPLE;
$templatefile = "Agenda_Pejabat_search.htm";

// for ajax query, used when page buffers new control
if(postvalue("mode")=="inlineLoadCtrl"){
	$mode=SEARCH_LOAD_CONTROL;
	$templatefile = "Agenda_Pejabat_inline_search.htm";
}	
...
$params['xt'] = &$xt;
$params['shortTableName'] = 'Agenda_Pejabat';
$params['origTName'] = $strOriginalTableName;
$params['dataSourceTable'] = "Agenda Pejabat";
...
//--------------------------------------------------------------------------------------	
	...
	{
	$contents_block["begin"].="action=\"Agenda_Pejabat_list.php\" ";
	}
