<div class="list-schedule">
		...
		<div class="btn-option">
	        <a class="print-button" id="print-my-schedule" data-url="<?php echo site_url('schedule/me/printout'); ?>" title="Print"><img class="button-action" src="<?php echo base_url('assets/images/icons/png/printer.png'); ?>"></a>
	        <a class="export-button" id="excel-my-schedule" data-url="<?php echo site_url('schedule/me/export'); ?>" target="_blank" title="Export to excel"><img class="button-action" src="<?php echo base_url('assets/images/icons/png/excel.png'); ?>"></a>
	    </div>
</div>