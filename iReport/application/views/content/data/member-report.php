<div class="report content">
	<div class="title">
		...
		<div class="title-text capitalize"><?php echo @$user['first_name']; ?>'s Report</div>
				...
				if($member)
				{
					foreach($member as $record)
					{
						...
						<div class="control-group">
				            <label class="control-label"><?php echo $record['first_name']; ?>'s Presences</label>
				            <div class="controls">
