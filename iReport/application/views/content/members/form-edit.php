<div class="edit-member content">
	<div class="title">
		...
		<div class="title-text">Edit Member</div>
	...
	<div class="row-fluid">
		...
		if($member)
		{
			?>
			<div class="span7">
				<form class="form-horizontal" action="<?php echo site_url('members/update')?>" method="post">
					<input type="hidden" name="user-ID" value="<?php echo $member['user_ID']; ?>">
					<div class="control-group">
						<label class="control-label">Username</label>
						<div class="controls">
							<input type="text" name="username" id="username" placeholder="type here .." value="<?php echo $member['user_nicename']; ?>">
						</div>
					</div>
					<div class="control-group">
